...
const videoUpload = asyncHandler(async (req, res) => {
    ...
    const shottieLocalPath = await processShottie(videoLocalPath, req?.user.username);
    const video = await uploadHLSonCloudinary(shottieLocalPath, req?.user.username);
